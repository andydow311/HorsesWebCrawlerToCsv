...
class Worker extends Actor{
  ...
  def receive: PartialFunction[Any,Unit] ={
    case data:(String, String) => {
      ...
      val horseDataAsArray = getHorseData(id, doc)
      writeOutHorseAndRaceDetails(horseDataAsArray, doc, file)
    }
  ...
  def getHorseData(id:String, doc:String): Array[String] = {
  ...
  def writeOutHorseAndRaceDetails(horse: Array[String] , doc:String, file:String): Unit ={
    ...
    for (elem <- rows) {
      ...
      writeRaceToCSV(horse,sequence,file)
  ...
  def writeRaceToCSV(horse: Array[String] , race: Array[String], file:String): Unit = {
